...
const Page = async () => {
  ...
  if (!user || user.email != ADMIN_EMAIL) {
    return notFound(); //or redirect() to home page still deciding
  }
  ...
  return <div className="flex min-h-screen w-full bg-muted/40">
    <div className="max-w-7xl w-full mx-auto flex flex-col sm:gap-4 sm:py-4">
        <div className="flex flex-col gap-16">
            ...
            <h1 className="4xl font-bold tracking-tight">
                Incoming Orders
            </h1>
                ...
                <TableBody>
                    {orders.map((order) => (
                        <TableRow key={order.id} className="bg-accent">
                            ...
                            <TableCell className="hidden sm:table-cell"> <StatusDropdown id={order.id} orderStatus={order.status}/>
                            </TableCell>
